...
*/
var template = "<div @click='aaa' @aaa='bbb+1' @click.native='ccc' onclick='ddd'></div>"
console.log(Vue.compile(template));

var template1 = "<div><button @click='abc'>click me</button></div>";
console.log(Vue.compile(template1));
...
app1 = new Vue({
	template:"<div><button @click='abc' @bbb='ccc'>click me</button></div>",
	data(){
		return {
			info:"root footer!",
	        items:["1","2","3"],
